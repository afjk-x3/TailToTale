<?php
session_start();
// Fetch notification counts for sidebar and navbar badges (reuse logic from profile.php)
...
<head>
    ...
    <title>Tail to Tale - Rehomer Home</title>
    ...
    <main>
        <section class="hero-section" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&fit=crop&w=1500&q=80'); background-size: cover; background-position: center; color: white;">
            <div class="hero-content">
                ...
                <p>Let us help you find the perfect new home for your beloved pet.</p>
                <div class="cta-buttons">
                    <a href="/TAILTOTALE/frontend/pages/rehome.php" class="btn primary-btn">Rehome a Pet</a>
                </div>
            </div>
        </section>
        <section class="process-section">
            <h2>Tips for Rehoming</h2>
            <div class="process-steps">
                <div class="step">
                    <i class="fas fa-check-circle"></i>
                    <h3>Prepare Your Pet</h3>
                    <p>Ensure your pet is healthy, well-groomed, and has updated vaccinations.</p>
                </div>
                <div class="step">
                    <i class="fas fa-camera-retro"></i>
                    <h3>Take Great Photos</h3>
                    <p>Clear, appealing photos significantly increase interest in your pet.</p>
                </div>
                <div class="step">
                    <i class="fas fa-file-alt"></i>
                    <h3>Write a Detailed Description</h3>
                    <p>Highlight your pet's personality, and health status.</p>
                </div>
                <div class="step">
                    <i class="fas fa-users"></i>
                    <h3>Screen Applicants Carefully</h3>
                    <p>Ask questions and consider a home visit to find the best match.</p>
                </div>
            </div>
        </section>
    </main>
